...
namespace _03_DAL.Conexion
{
    public class clsMyConnection
    {
        ...
        {
            this.dataBase = "iesnervion.database.windows.net";
        ...
        public SqlConnection getConnection()
        {
            ...
            try
            {
                ...
                connection.ConnectionString = string.Format("Server=tcp:iesnervion.database.windows.net,1433;Initial Catalog=WPFSample;Persist Security Info=False;User ID=prueba;Password=iesnervion123.;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
                connection.Open();
            }
            catch (SqlException)
            {
